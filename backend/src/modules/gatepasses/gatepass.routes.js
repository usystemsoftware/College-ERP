...
router.get('/', protect, authorize('Security Officer', 'College Admin', 'Principal', 'Super Admin'), getGatePasses);
router.post('/', protect, createGatePass);
router.patch('/:id/approve', protect, authorize('Security Officer', 'College Admin', 'Principal', 'Super Admin'), approveGatePass);
