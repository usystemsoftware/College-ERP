...
const Modal = ({ isOpen, onClose, title, hideFooter, children }) => {
  ...
  return createPortal(
    <div className="fixed inset-0 z-[9999] flex items-center justify-center bg-slate-900/40 backdrop-blur-sm dark:bg-black/60">
      <div className="relative w-full max-w-md rounded-xl bg-white p-6 shadow-2xl dark:bg-dark-900 border border-slate-200 dark:border-slate-800 m-4 max-h-[95vh] flex flex-col">
